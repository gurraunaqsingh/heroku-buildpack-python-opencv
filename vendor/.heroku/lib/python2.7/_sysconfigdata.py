...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BASEMODLIBS': '',
 'BEOS_THREADS': 0,
 'BINDIR': '/app/.heroku/bin',
 'BINLIBDEST': '/app/.heroku/lib/python2.7',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/app/.heroku/'",
 'CONFINCLUDEDIR': '/app/.heroku/include',
 'CONFINCLUDEPY': '/app/.heroku/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++ -pthread',
 'C_THREADS': 0,
 'DESTDIRS': '/app/.heroku /app/.heroku/lib /app/.heroku/lib/python2.7 /app/.heroku/lib/python2.7/lib-dynload',
 'DESTLIB': '/app/.heroku/lib/python2.7',
 'DESTPATH': '',
 'DESTSHARED': '/app/.heroku/lib/python2.7/lib-dynload',
 'DIRMODE': 755,
 ...
 'HURD_C_THREADS': 0,
 'INCLDIRSTOMAKE': '/app/.heroku/include /app/.heroku/include /app/.heroku/include/python2.7 /app/.heroku/include/python2.7',
 'INCLUDEDIR': '/app/.heroku/include',
 'INCLUDEPY': '/app/.heroku/include/python2.7',
 ...
 'LIBC': '',
 'LIBDEST': '/app/.heroku/lib/python2.7',
 'LIBDIR': '/app/.heroku/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBP': '/app/.heroku/lib/python2.7',
 'LIBPC': '/app/.heroku/lib/pkgconfig',
 'LIBPL': '/app/.heroku/lib/python2.7/config',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/app/.heroku/lib/python2.7',
 'MACH_C_THREADS': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/app/Python-2.7.6:/app/.heroku/vendor/lib',
 'SCRIPTDIR': '/app/.heroku/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/app/Python-2.7.6:/app/.heroku/vendor/lib ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/app/Python-2.7.6',
 'abs_srcdir': '/app/Python-2.7.6',
 'build': 'x86_64-unknown-linux-gnu',
 'datarootdir': '/app/.heroku/share',
 'exec_prefix': '/app/.heroku',
